"""
Django settings for VORD project.
...
ROOT_URLCONF = 'onlinebankingportalproject.urls'
...
WSGI_APPLICATION = 'onlinebankingportalproject.wsgi.application'
